...
const HomePage: React.FC = () => {
  return (
    <div className="w-full flex flex-col min-h-screen">
      {/* Hero Banner */}
      <div className="w-full bg-gray-50 flex-1 flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
              <Link
                to="/programs"
                className="w-48 sm:w-56 inline-flex items-center justify-center px-6 py-4 border border-transparent text-base font-medium rounded-md text-secondary bg-tertiary-600 hover:bg-tertiary-700 md:text-lg transition-colors duration-200"
              >
                Explore Programs
              </Link>
              <Link
