      ...
      <div className="bg-primary text-secondary flex-grow flex items-center justify-center py-20">
        <div className="container mx-auto px-4 text-center">
          <div className="flex justify-center mb-6">
            <MdCancel className="w-28 h-28 md:w-40 md:h-40 text-red-500" />
          </div>
          ...
          <div className="flex justify-center">
            <button onClick={scrollToDetails} className="flex flex-row items-center gap-3 text-secondary hover:text-tertiary-400 transition-colors cursor-pointer">
              <span className="text-base md:text-lg font-semibold">View Cancellation Details</span>
          ...
          <div className="max-w-2xl mx-auto text-left border border-primary-200 p-6 rounded-lg">
            ...
            <div className="space-y-6">
              <div className="border-b border-primary-200 pb-6">
                ...
                <p className="text-primary text-opacity-80 text-lg">Cancelled</p>
              </div>
              <div className="border-b border-primary-200 pb-6">
                <p className="text-primary text-opacity-90 mb-2">
                  <span className="font-semibold text-lg">Transaction Details</span>
                </p>
                <p className="text-primary text-opacity-80 text-lg">You were redirected from the payment page before completing your transaction. <span className="font-bold underline">Your account has not been charged</span>.</p>
              </div>
              <div>
                <p className="text-primary text-opacity-90 mb-2">
                  <span className="font-semibold text-lg">Need Help?</span>
                </p>
                <p className="text-primary text-opacity-80 text-lg">
                  <button onClick={() => navigateToTop('/contact')} className="text-tertiary-600 hover:text-tertiary-700 font-semibold bg-none border-none cursor-pointer p-0">Contact us</button> for any questions or concerns.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-primary text-secondary py-10 md:py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-8 md:mb-10">Ready to Try Again?</h2>
